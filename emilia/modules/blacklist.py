...
Contoh nilai waktu: 4m = 4 menit, 3h = 3 jam, 6d = 6 hari, 5w = 5 minggu."""
		...
		return "<b>{}:</b>\n" \
				"<b>Admin:</b> {}\n" \
				"Telah mengubah mode blacklist. Pengguna akan {}.".format(html.escape(chat.title),
...
BLACKLIST_DEL_HANDLER = MessageHandler(
	(Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.group & Filters.update.edited_message, del_blacklist)
