...
from emilia import dispatcher, LOGGER, OWNER_ID, spamfilters, TEMPORARY_DATA
            ...
            if data.get("bot_base") == "Emilia":
                ...
                if data["greetings"].get("security"):
                    ...
                    welcsql.set_welcome_security(
                        chat_id, bool(secenable), str(sectime), str(secbtn)
                    )
                    imp_greet_pref = True
                ...
                if data.get("data"):
                    ...
                    if data["data"].get("greetings"):
                        ...
                        if data["data"]["greetings"].get("mute_text"):
                            getcur, cur_value, cust_text = welcsql.welcome_security(
                                chat_id
                            )
                            welcsql.set_welcome_security(
                                chat_id,
