...
RAMALAN_STRINGS = (
	"Know that you're capable of living with awareness ✌️",
	"Extend a moment of gratitude for all the work that's going on in your body, supporting you and giving you life 👏",
	"Ask yourself, are you present or on autopilot? ✈️\nAre you being intentional or reactive?",
	"Are you happy?\nIf not, take the risk of being happy 😊",
	"Research shows that making an oath to perform a behavior increases the likelihood you'll follow through\nSo make a vow to practice gratitude – it can be as simple as writing a note to yourself that says \"Count your blessings\" ✏️",
	"Cultivate a more unconditional kindness towards yourself and others",
	"Focus on your breath when you're feeling an intense emotion\nBreathing can reset your state of mind",
	"Remember that everybody wants to feel heard and understood 👂",
	"You're worthy: you're definitely good enough\nBelieve that in your heart ❤️",
	"When you experience anger, bring awareness to your breathing 💫",
	"Try to focus inwards before looking outwards 😌",
	"Think about 3 people you're grateful to have in your life 👪",
	"Try to separate fact from judgment\nAsk yourself, are my thoughts really true? 🌱",
	"Pause for a second before you respond to an email you've received\nDo the same thing before you hit 'send' on one you've written 💻",
	"Make someone feel heard and appreciated today 😊",
	"\"The inspiration you seek is already within you. Be silent and listen.\" 👂\n–Rumi",
	"For your next meal, try to eat mindfully\nPut down your utensil between bites 🍴",
	...
	"You can find the ability to achieve your goals by finding the time first\nStart by carving out an hour or so on your calendar",
	"When you experience an unpleasant emotion, remember you have the power to change the situation\nThen accept the choice you've made 🚩",
