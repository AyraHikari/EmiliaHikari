...
# notes
	...
	"Ok, `{note_name}` ditambahkan di *{chat_name}*.\ndapatkan dengan `/get {note_name}`, atau `#{note_name}`": "Ok, `{note_name}` added in *{chat_name}*.\nget with `/get {note_name}`, or `#{note_name}`",
	"Catatan di *{}* untuk `{}` berhasil dihapus 😁": "Removed notes in *{}* for `{}` 😁",
	"Catatan di *{}* untuk `{}` gagal dihapus!": "Failed to remove notes in *{}* for `{}`!",
	"Catatan di *{}* untuk `{}` berhasil dihapus 😁\nCatatan {}gagal dihapus!": "Removed notes in *{}* for `{}` 😁\nalso failed to delete {}!",
...
""",
	...
	"Admin grup belum menetapkan aturan apa pun untuk *{}*. Bukan berarti obrolan ini tanpa hukum...!": "The group admins haven't set any rules for this chat yet. This probably doesn't mean it's lawless though...!",
...
# welcome
	...
	"Obrolan ini memiliki preferensi `{}` untuk pesan sambutan.\nUntuk preferensi pesan selamat tinggal `{}`.Bot `{}` menghapus notifikasi member masuk/keluar secara otomatis": "This chat has it's welcome preference set to `{}`.\nIt's goodbye preference is `{}`.",
	"welcome_help": """
*Hanya admin:*
...
# Only for Special module
 ...
 - /forecast: check your forecast today
...
RAMALAN_STRINGS = (
	"Laugh as much as you like before it's prohibited 😆",
	"If you make someone happy, you yourself will feel happy.\nThat's how the world works 😊",
	"The youth nostalgia of today will make you smile 🌸",
	"Continue on with your work, surely it will be finished too.\nOkay, I admit the prediction today is little funny 😝",
	"Knowing that illusion is not reality does not make its beauty diminish 💖",
	"You will experience a strange event today.\nAnd that does not include getting a prophecy from Emilia 😜",
	"Finally there is an opportunity to rest...\nAnd hear the prophecy from Emilia 😉",
	"Your search is complete.\nYou have found a true friend (me) 😀",
	"You will show that you are strong past challenges after challenges.",
	"You're just a drop of water in the middle of the vast ocean.\nBut even a speck of water can make a gadget broken 😱 💦",
	"You will try new things today.\nBut sorry, trying free food at the supermarket is not included 🍦🚫",
	"Send a message to an old friend today.",
	"There will be something new in the environment around you 🏡",
	"Treat yourself 🍭",
	"Everything has a solution, if you are open to change.",
	"Good karma approaches you this week.\nBut be careful, karma is fragile like glassware.",
	"Spend time outdoors today.\nIt looks like it's out there beautiful ... if it's not raining.",
	"If you listen intently, the wind will give you all the answers to your questions 💨",
	"Go to a place you have never visited, even though it is only a stone's throw from your home.",
	"You will receive good news, but maybe you should look for what is implied.",
	"You will immediately find what you are looking for.\nIf you can find your glasses.",
	"Go to a new place.\nWhat you will find will definitely be impressive.",
	"Opportunities will arise if you know where to look 👀",
	"Today you will be cool 😎\nWell, it's not too different from other days 😉",
	"Positive things will appear in your life today.\nBut don't forget, in the composition of an atom there is always a negative atom 🔬😀",
	"Fulfill only with kindness, both in mind, word, deed, and twitting 🐥",
	"Be prepared to accept fun things today 😎",
	"Time to learn new skills and topics.",
	"Your favorite YouTube video hasn't been created yet.",
	"When in doubt, Google first 😉",
	"Two days from now, tomorrow will be yesterday 😌",
	"Pay attention to the details.\nThere must be many interesting things that you can find.",
	"Wow, you haven't been lucky yet. Please try again 😉",
	"Make a decision by listening and harmonizing your heart and mind.",
	"Usually thieves will shout thieves.",
	"You will not be given if you don't ask 👐",
	"The youth nostalgia of today will make you smile 🌸",
	"Your true friends are within reach.\nIn fact, you are reading a forecast from him 😊",
	"Your future will be filled with success 💎\nBut be careful, greed can destroy everything 💰",
	"Today is the tomorrow you were waiting for yesterday.",
	"Gratitude will make us happy.\nSay thank you to someone today.",
	"Today, the world will be yours 🌍\nDo not forget to make it beautiful for others 😊",
	"A new adventure will soon come to you.",
	"The more you say, the less they will remember.",
	"Today, be a superhero for a child.",
	"The food that seems strange may actually be really good.",
	"Today, take another route than usual.",
	"Time to express your creativity.",
	"Your soul mate is closer than you think 💞",
	"Time to learn new skills and topics.",
	"Positive things will appear in your life today.\nBut don't forget, in the composition of an atom there is always a negative atom 🔬😀",
	"Time to take a vacation with your favorite people ✈️",
	"Tomorrow will be a more enjoyable day than your most annoying day.",
	"Do not look for fortune on the website or suspicious SMS.",
	"Unexpected events will approach your life.",
	"A valuable gift awaits you.\nBut it seems that the gift is very patient.",
	"Your family is missing you.\nCall them, don't tell me my idea 😉",
	"Good day to fight for the truth.",
	"Everything has a solution, if you are open to change.",
	"Pets will add to your happiness 🐱🐹🐔",
	"When you fall, wake up again.\nAnd don't forget to clean the wound 👍",
	"Drink enough water today.\nThis is not really a forecast, I just want you to stay healthy 😊",
	"Let your intuition show you the way.\nBut the writing containing the applicable terms and conditions must be read carefully.",
	"Good things will come for those who...\nPatient.",
	...
	"The right time to be yourself.",
	"Even though it's annoying, the person closest to you cares more about you than he who looks sweet but is just small talk.",
	"Pursue the sun, surely the darkness will pass you.",
	"Your life will be immortalized in a documentary.",
	"Children's laughter will make your day enjoyable.",
	"It's time to find a new hobby.",
	"Love is not static.\nIt is dynamic like an alternating electric current 💖",
	"The wait will end soon 😁",
	"Pay attention to the details.\nThere must be many interesting things that you can find.",
	"Two days from now, tomorrow will be yesterday 😌",
	"You will hear a song that makes you smile for days.",
	"Meet ideals.\nKiss the dream 😘🌛",
	"All roses must be spiny 🌹\nBe someone who is always ready to cut the thorn.",
	"Many people are amazed at your talents and abilities... more than you realize 👏",
	"Do what you love today 💞\nI promise you will feel happy, even if only for a moment 😃",
	"Luck will come for brave people.",
	"You will not be given if you don't ask 👐",
	"Try drawing something ✏️\nYou will enjoy it.",
	"It's time to change your dress style? 👠",
	"Try to be consistent with all your words.",
	"The right day to appreciate and be grateful for small things.",
	"Tonight you will have a beautiful dream.\nBut I don't promise you can remember the dream 😉",
	"You will show that you are strong past challenges after challenges.",
	"A great day to tell your family and friends about me 😉",
	"take a break and chat from heart to heart with people you care about 👨‍👩‍👧‍👦",
	"Everything will go according to plan.",
	"Go to a new place.\nWhat you will find will definitely be impressive.",
	"This is one of the times when you wonder about the meaning of life.",
	"Do not be fooled by predictions 😏"
)

RAMALAN_FIRST = (
	"I am not a psychic, but indeed I can predict a little.\n",
	"A forecast is ready to slide.\n",
