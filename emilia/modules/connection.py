...
from telegram import Chat, Update, Bot, User, error
...
def disconnect_chat(bot, update):
    ...
    if update.effective_chat.type == "private":
        ...
        if disconnection_status:
            ...
            update.effective_message.reply_text(
                languages.tl(
                    update.effective_message, "Memutus sambungan tidak berhasil!"
                )
            )
    else:
        update.effective_message.reply_text(
...
def help_connect_chat(bot, update, args):
    ...
    if update.effective_message.chat.type != "private":
        ...
        update.effective_message.reply_text(
            languages.tl(update.effective_message, "supportcmd"), parse_mode="markdown"
        )
...
HELP_CONNECT_CHAT_HANDLER = CommandHandler(
    "helpconnect", help_connect_chat, allow_edited=True, pass_args=True
)
